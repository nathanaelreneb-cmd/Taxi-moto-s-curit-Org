    ...
    <div className="shell" style={{ maxWidth: 460 }}>
      ...
      <div className="card" style={{ marginBottom: 16 }}>
        <p className="hint" style={{ marginBottom: 8 }}>
          Recevez une alerte sur ce téléphone quand une moto est signalée volée dans le
          quartier — même sans ouvrir l&rsquo;application.
        </p>
        <button
          className="btn-ghost"
          type="button"
          onClick={async () => {
            ...
            if (res.ok) alert('Alertes activées sur ce téléphone.');
            else if (res.reason === 'denied') alert('Autorisation refusée dans les réglages du navigateur.');
            else alert("Ce téléphone ne peut pas recevoir ces alertes pour l'instant.");
          }}
        >
          🔔 Recevoir les alertes de vol
        </button>
      </div>
